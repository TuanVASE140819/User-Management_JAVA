...
public class UserDAO {
    ...
    public int updateUser(int userID, String userName, String password, String email, String phone, String photo, boolean status, int rank, int roleID) throws NamingException, SQLException {

        try {
            con = DBHelper.makeConnection();
            if (con != null) {
                String sql = "update tblUsers\n"
                        + "set UserName = ?,PassWord = ?,Email = ?, Phone = ?, Photo = ?,Status = ?, intRank = ?, RoleID = ?\n"
                        + "where UserID = ?";
    ...
    public int removeUser(int userID, boolean status) throws NamingException, SQLException {
